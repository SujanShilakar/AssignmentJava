...
<title>Question Two Calculator</title>
<body>
<div class="container">
    <form action="calculator" name="forms">
        <input type="text" name="answer">
        <div class="buttons">
            <input type="button" id="clear-all" value="C" >
            <input type="button" id="clear-one" value="DEL" >
            <input type="button" id="divide" class="operators" value="/" >
        </div>
        <div class="buttons">
            ...
            <input type="button" id="multiply" class="operators" value="*" >
        </div>
        <div class="buttons">
            ...
            <input type="button" id="subtract" class="operators" value="-" >
        </div>
        <div class="buttons">
            ...
            <input type="button" id="add" class="operators" value="+" >
        </div>
        <div class="buttons">
            <input type="button" id="zero" class="number" value="0" >
            <input type="button" id="double-zero" class="number" value="00" >
